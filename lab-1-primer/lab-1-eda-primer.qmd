...
This Primer will introduce you to using Markdown to create documents. The .qmd files you are using are **Q**uarto documents that are written with **m**ark**d**own. If you have used RMarkdown files before, these are extremely similar.  
